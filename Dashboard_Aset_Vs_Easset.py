...
# SIDEBAR NAV
# =========================
if st.sidebar.button("📊 Dashboard Aset Vs Easset", key="nav_dashboard", use_container_width=True):
    pass  # dah berada di page 1

if st.sidebar.button("📋 Senarai Pemilikan Aset", key="nav_senarai", use_container_width=True):
    st.switch_page("pages/2_Senarai_Pemilikan_Aset.py")
...
/* ✅ HOVER ATAS ACTIVE (INI YANG HILANG TADI) */
section[data-testid="stSidebar"]
